...
{
    return WInputDevice::configSendEventsMode(libinput_device_handle(), mode);
}

bool WInputDevice::setTapButtonMap(libinput_config_tap_button_map map)
{
    return WInputDevice::configTapButtonMap(libinput_device_handle(), map);
}

bool WInputDevice::setTapEnabled(libinput_config_tap_state tap)
{
    return WInputDevice::configTapEnabled(libinput_device_handle(), tap);
}

bool WInputDevice::setTapDragEnabled(libinput_config_drag_state drag)
{
    return WInputDevice::configTapDragEnabled(libinput_device_handle(), drag);
}

bool WInputDevice::setTapDragLock(libinput_config_drag_lock_state lock)
{
    return WInputDevice::configTapDragLockEnabled(libinput_device_handle(), lock);
}

bool WInputDevice::setAccelSpeed(qreal speed)
{
    return WInputDevice::configAccelSpeed(libinput_device_handle(), speed);
}

bool WInputDevice::setRotationAngle(qreal angle)
{
    return WInputDevice::configRotationAngle(libinput_device_handle(), angle);
}

bool WInputDevice::setAccelProfile(libinput_config_accel_profile profile)
{
    return WInputDevice::configAccelProfile(libinput_device_handle(), profile);
}

bool WInputDevice::setNaturalScroll(bool natural)
{
    return WInputDevice::configNaturalScroll(libinput_device_handle(), natural);
}

bool WInputDevice::setLeftHanded(bool left)
{
    return WInputDevice::configLeftHanded(libinput_device_handle(), left);
}

bool WInputDevice::setClickMethod(libinput_config_click_method method)
{
    return WInputDevice::configClickMethod(libinput_device_handle(), method);
}

bool WInputDevice::setMiddleEmulation(libinput_config_middle_emulation_state mid)
{
    return WInputDevice::configMiddleEmulation(libinput_device_handle(), mid);
}

bool WInputDevice::setScrollMethod(libinput_config_scroll_method method)
{
    return WInputDevice::configScrollMethod(libinput_device_handle(), method);
}

bool WInputDevice::setScrollButton(uint32_t button)
{
    return WInputDevice::configScrollButton(libinput_device_handle(), button);
}

bool WInputDevice::setScrollButtonLock(libinput_config_scroll_button_lock_state lock)
{
    return WInputDevice::configScrollButtonLock(libinput_device_handle(), lock);
}

bool WInputDevice::setDwt(libinput_config_dwt_state enable)
{
    return WInputDevice::configDwtEnabled(libinput_device_handle(), enable);
}

bool WInputDevice::setDwtp(libinput_config_dwtp_state enable)
{
    return WInputDevice::configDwtpEnabled(libinput_device_handle(), enable);
}

bool WInputDevice::setCalibrationMatrix(float mat[])
{
    return WInputDevice::configCalibrationMatrix(libinput_device_handle(), mat);
}

bool WInputDevice::ensureStatus(libinput_config_status status)
{
...
bool WInputDevice::configSendEventsMode(libinput_device *device, uint32_t mode)
{
...
bool WInputDevice::configTapEnabled(libinput_device *device, libinput_config_tap_state tap)
{
...
bool WInputDevice::configTapButtonMap(libinput_device *device, libinput_config_tap_button_map map)
{
    if (libinput_device_config_tap_get_finger_count(device) <= 0 ||
...
bool WInputDevice::configTapDragEnabled(libinput_device *device, libinput_config_drag_state drag)
{
    if (libinput_device_config_tap_get_finger_count(device) <= 0 ||
...
bool WInputDevice::configTapDragLockEnabled(libinput_device *device, libinput_config_drag_lock_state lock)
{
    if (libinput_device_config_tap_get_finger_count(device) <= 0 ||
...
bool WInputDevice::configAccelSpeed(libinput_device *device, double speed)
{
...
bool WInputDevice::configRotationAngle(libinput_device *device, double angle)
{
...
bool WInputDevice::configAccelProfile(libinput_device *device, libinput_config_accel_profile profile)
{
    if (!libinput_device_config_accel_is_available(device) ||
...
bool WInputDevice::configNaturalScroll(libinput_device *device, bool natural)
{
...
bool WInputDevice::configLeftHanded(libinput_device *device, bool left)
{
...
bool WInputDevice::configClickMethod(libinput_device *device, libinput_config_click_method method)
{
...
bool WInputDevice::configMiddleEmulation(libinput_device *device, libinput_config_middle_emulation_state mid)
{
...
bool WInputDevice::configScrollMethod(libinput_device *device, libinput_config_scroll_method method)
{
...
bool WInputDevice::configScrollButton(libinput_device *device, uint32_t button)
{
    uint32_t scroll = libinput_device_config_scroll_get_methods(device);
    if ((scroll & ~LIBINPUT_CONFIG_SCROLL_NO_SCROLL) == 0 ||
...
bool WInputDevice::configScrollButtonLock(libinput_device *device, libinput_config_scroll_button_lock_state lock)
{
    uint32_t scroll = libinput_device_config_scroll_get_methods(device);
    if ((scroll & ~LIBINPUT_CONFIG_SCROLL_NO_SCROLL) == 0 ||
...
bool WInputDevice::configDwtEnabled(libinput_device *device, enum libinput_config_dwt_state enable)
{
...
bool WInputDevice::configDwtpEnabled(libinput_device *device, enum libinput_config_dwtp_state enable)
{
...
bool WInputDevice::configCalibrationMatrix(libinput_device *device, float mat[])
{
